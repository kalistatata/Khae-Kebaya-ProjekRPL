            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">ABOUT OUR KHAE KEBAYA</h3>
                        <p>We are keeping a high standard to all across our production chain, from sourcing the right material, creating the right cutting, a good quality sewing, embroidery, sequins, etc. Besides, all of our product is going through the process of quality control in order to ensure only the perfect products that finally goes to each of our customer’s hand. 
                        <br><br>
                        For this reason, our each design serves an idea. Our strength in design is reflected by our name, our care for details. We don't require everything to be perfect, but we need them to be perfectly cared for. That's a reason why we are willing to give contributions at best. The amount of dedication and effort equals to the level of passion and determination. Get better, together as one.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row mb-n6">
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="team-content">
                                <h6 class="team-name font--bold mt-5">Kalista Yasila</h6>
                                <span class="team-title">M0521038</span>
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="team-content">
                                <h6 class="team-name font--bold mt-5">Karin Angela</h6>
                                <span class="team-title">M0521040</span>
                                <ul class="team-social pos-absolute">
                                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="#"><i class="ion-social-instagram"></i></a></li>
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="team-content">
                                <h6 class="team-name font--bold mt-5">Keysa Afgrinadika</h6>
                                <span class="team-title">M0521041</span>
                                <ul class="team-social pos-absolute">
                                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="#"><i class="ion-social-instagram"></i></a></li>
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div class="team-content">
                                <h6 class="team-name font--bold mt-5">Kharisma Sari Dewi</h6>
                                <span class="team-title">M0521042</span>
                                <ul class="team-social pos-absolute">
                                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="#"><i class="ion-social-instagram"></i></a></li>
